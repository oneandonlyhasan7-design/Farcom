...
class ContactsListViewModel
    ...
    val isDefaultAccountFarcom = MutableLiveData<Boolean>()
    ...
    @UiThread
    fun changeContactsFilter(onlyFarcomContacts: Boolean, onlySipContacts: Boolean) {
        coreContext.postOnCoreThread {
            domainFilter = if (onlyFarcomContacts) {
    ...
    private fun checkIfDefaultAccountOnDefaultDomain() {
        ...
        isDefaultAccountFarcom.postValue(isAccountOnDefaultDomain)
    }
}
